...
PLATFORM_CONFIGS = {
    ...
    "douyin": {
        ...
        "selectors": {
            ...
            "title_editor": ['input[placeholder="填写作品标题，为作品获得更多流量"]', 'input[placeholder="添加作品标题"]', 'input.semi-input.semi-input-default'],
            "textbox_selectors": ['div[data-line-wrapper="true"]', 'div.zone-container.editor-kit-container.editor.editor-comp-publish', 'div.zone-container.editor-kit-container.editor'],
            "thumbnail_button": ["//span[contains(text(), '添加封面')]"],
